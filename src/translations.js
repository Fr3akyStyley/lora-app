...
export const UI_TEXT = {
  sr: {
    ...
    premium_status_inactive: "Trenutno koristiš besplatnu verziju.",
    premium_intro: "Premium otključava:",
    premium_feature_history: "Neograničena istorija partija (umesto {limit} poslednjih)",
    premium_feature_ads: "Aplikacija bez reklama",
    premium_comingSoon: "Kupovina premiuma će biti dostupna kada aplikacija izađe na Play Store.",
    premium_loginRequired: "Prijavi se Google nalogom da bi mogao da aktiviraš Premium.",
    premium_back: "Nazad",
  ...
  en: {
    ...
    home_premium: "⭐ Premium",
    premium_title: "⭐ Premium",
    premium_status_active: "Premium is active on your account. Thanks for the support! 🎉",
    premium_status_inactive: "You're currently on the free version.",
    premium_intro: "Premium unlocks:",
    premium_feature_history: "Unlimited game history (instead of the last {limit})",
    premium_feature_ads: "Ad-free app",
    premium_comingSoon: "Buying premium will be available once the app is released on the Play Store.",
    premium_loginRequired: "Sign in with Google to be able to activate Premium.",
    premium_back: "Back",
